...
const Navigation: React.FC<Props> = ({
  ...
  return (
    <div className="bg-linear-to-r relative overflow-hidden border-b border-white/10 from-purple-600/90 via-pink-500/90 to-indigo-500/90 text-white shadow-lg">
      <div
          ...
          <div className="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center sm:justify-end sm:gap-4">
            <div className="w-full sm:max-w-md">
              <SearchBar
                ...
                className="shadow-purple-300/40"
              />
            </div>
            ...
            {categories.map((category) => {
              ...
              return (
                <button
                  ...
                  className={`whitespace-nowrap rounded-full px-4 py-1.5 text-sm font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 ${
                    isSelected
