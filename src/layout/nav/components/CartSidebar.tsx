                ...
                <div className="flex-1 space-y-4 overflow-y-auto px-6">
                    { cart.length === 0 ? (
                        <div className="flex h-full flex-col items-center justify-center gap-3 rounded-3xl bg-purple-50/60 p-8 text-center">
                            <Title h5 semibold className="text-purple-600" text="Dein Warenkorb ist noch leer" />
                            <TextParagraph sm className="text-gray-500" text="Füge Produkte hinzu, um sie hier zu sehen." />
                        </div>
                    ) : (
                        cart.map( ( item ) => (
                            <article
                            ...
                            >
                                ...
                                <div className="flex-1 space-y-1">
                                    ...
                                    <p className="text-sm font-medium text-purple-600">{ formatPrice( item.price ) }</p>
                                </div>
                                <button
                                    type="button"
