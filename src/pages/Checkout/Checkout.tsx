...
import { Button, Card, CardContent, CardHeader, CardTitle, Input, Label, Separator, RadioGroup, RadioGroupItem } from '@ui/.'
                ...
                <CardContent className="space-y-4">
                  <RadioGroup value={ paymentMethod } onValueChange={ setPaymentMethod }>
                    ...
                    <div className="flex items-center space-x-2 p-4 border rounded-lg">
                      ...
                      <Label htmlFor="sofort" className="cursor-pointer flex-1">
                        Sofortüberweisung
                      </Label>
                    </div>
                  </RadioGroup>
