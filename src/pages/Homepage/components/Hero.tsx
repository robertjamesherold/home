...
const Hero: React.FC<HeroType> = ({ title, subtitle, buttonText, buttonLink }: HeroType) =>
{
    ...
    <Section className="relative h-[600px] flex items-center justify-center bg-gray-100">
        ...
        <Container className="relative z-10 text-center text-white max-w-3xl px-4">
            <Title level={ 1 } weight='bold' className="mb-6" text={ title } />
            <TextParagraph className="text-xl mb-8 opacity-90" text={ subtitle } />
            <Link to={ buttonLink }>
