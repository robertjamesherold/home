...
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow, Tabs, TabsContent, TabsList, TabsTrigger, Card, CardContent } from "@ui/."
...
export function ProductDetails ()
{
    ...
    return (
            <Card className="w-full ">
                ...
                <TabsList className="w-full border-b border-slate-900 rounded-b-none grid-cols-4 bg-slate-200 flex ">
                    <TabsTrigger value="article" className='rounded-xl  rounded-b-none rounded-r-none'>Artikelangaben</TabsTrigger>
                    <TabsTrigger value="dimensions" className='rounded-none'>Maße</TabsTrigger>
                    <TabsTrigger value="additional" className='rounded-xl  rounded-b-none rounded-l-none'>Zusätzliche Angaben</TabsTrigger>
                        </TabsList>
