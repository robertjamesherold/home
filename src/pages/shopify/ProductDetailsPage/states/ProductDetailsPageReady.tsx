...
const SERVICE_HIGHLIGHTS: ServiceHighlight[] = [
  {
    ...
    description:
      'Bestellungen bis 12 Uhr verlassen noch am gleichen Tag unser Lager.',
  },
  {
    icon: Shield,
    label: '2 Jahre Garantie',
    description:
      'Kostenfreier Reparatur- oder Austauschservice bei Materialfehlern.',
  },
  {
    icon: Check,
    label: 'Geprüfte Qualität',
    description:
      'Jedes Produkt wird vor dem Versand sorgfältig auf Funktion geprüft.',
  },
];
...
const ProductDetailsPageReady: React.FC<ProductDetailsPageReadyProps> = ({
  ...
  return (
    <div className="bg-linear-to-br min-h-screen from-violet-50 via-pink-50 to-blue-50">
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)] lg:items-start lg:gap-16">
          <div className="flex flex-col gap-6 lg:sticky lg:top-8">
            <ImageSection
              ...
              galleryImages={
                galleryImages.length > 0 ? galleryImages : [primaryImage]
              }
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-wrap items-baseline gap-4 text-gray-900">
                  <Title
                    h2
                    bold
                    className="text-3xl text-violet-600 sm:text-4xl"
                    text={pricing.priceDisplay}
                  />
                  <Title
                    h4
            ...
            {activeTab === 'shipping' && (
              <div className="space-y-4 text-gray-700">
                <Title
                  ...
                  text="Versand & Retouren"
                />

                <TextParagraph
                  className="text-gray-700"
                  text={`Wir liefern innerhalb von 2-3 Werktagen klimaneutral zu
                                    dir nach Hause. Du erhältst nach dem Versand eine Sendungsverfolgung per E-Mail.`}
                />

                <ul className="list-inside list-disc space-y-2">
                  <TextParagraph
                    className='before:-left-0.75 relative flex pl-3 before:absolute before:-mt-0.5 before:text-xl before:content-["•"]'
                    text="Kostenloser Standardversand"
                  />
                  <TextParagraph
                    className='before:-left-0.75 relative flex pl-3 before:absolute before:-mt-0.5 before:text-xl before:content-["•"]'
                    text="Expressversand bei Bestellungen vor 12 Uhr"
                  />
                  <TextParagraph
                    className='before:-left-0.75 relative flex pl-3 before:absolute before:-mt-0.5 before:text-xl before:content-["•"]'
                    text="Kostenloser Rückversand innerhalb Deutschlands"
                  />
                  <TextParagraph
                    className='before:-left-0.75 relative flex pl-3 before:absolute before:-mt-0.5 before:text-xl before:content-["•"]'
