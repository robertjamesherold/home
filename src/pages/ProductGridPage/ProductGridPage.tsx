...
import { ProductCard, SelectButton, NoFilteredProducts, DesktopFilter, FilterMenu } from './components'
...
const ProductGridPage: React.FC = () =>
{
  ...
  const { sortBy, setSortBy, filteredProducts, selectedCategories, handleCategoryToggle, priceRange, setPriceRange, setSelectedCategories } = useFilter( productsData, { searchTerm: searchQuery } )
       ...
       <DesktopFilter
        ...
        {/* Product Grid */ }
          <Column className="flex-1">
            <Row className="items-center justify-between mb-6 gap-12">
              <Button
                variant="default"
            ...
            <Grid className="grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
