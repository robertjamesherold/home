...
{
  {
    ...
    {
      return (
        <div className="relative h-full justify-center items-center  flex  mx-auto px-4 py-16">
                ...
                <CardContent className="p-4">
                  <div className="flex gap-4">
                    <div className="w-24 h-24 shrink-0 overflow-hidden rounded-md bg-gray-100">
                      ...
                      { getRandomImageUrls( 2, { cacheKey: item.product.id } ).map( ( img ) => (
                    ...
                    <div className="flex-1 flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                      <div className="flex-1">
                        <Link to={ `/product/${ item.product.id }` }>
                          <h3 className="mb-1 hover:underline">{ item.product.name }</h3>
                        </Link>
